...
**I have retained the use of quantity symbols and names from the first edition. The SI system was updated in 2018 and the IUPAC Gold Book in 2020. I/we have to check that the symbols and nomenclature we use are up-to-date with these updates.**
...
As a source of energy, radiation if in excess, can damage unprotected tissues through uncontrolled photochemical reactions, i.e., by UV-B exposure breaking bonds in molecules [e.g., @xxxxx]. However, these short wavelengths together with longer wavelengths make organisms and objects warmer when they are absorbed. Thus, radiation-driven overheating can also damage tissues and cause the death of organisms, including plants [e.g., @xxxxx]. 

Depending on the intensity and timing, radiation of any wavelength from UV-B to thermal infrared can be damaging or beneficial to organisms, including plants. For a given exposure to radiation, the optical properties of vegetation, plants, individual organs such as leaves, tissues, cells and even organelles modulate the fate of the incident energy: radiation that is not absorbed or that is safely dissipated after absorption does not cause damage.

Sensing of light through photoreceptors [@fig-photoreceptors] as well as its conversion into chemical energy by photosynthesis, start at a photochemical reaction where one (or occasionally two or more) photons transfer energy to a pigment molecule to excite it. Quantum physics helps explain phenomena observable at larger scales.

![The range of wavelengths sensed through different higher-plant photoreceptors in _daylight_.](){#fig-photoreceptors}

From the perspective of research methods, radiation needs to be quantified in a way relevant to the object under study. The optical properties of experimental set-ups, need to be adjusted to the aims of each experiment and, crucially, have to be accurately described. In many cases, understanding of what is under study also depends on the description of the optical properties of plants or their parts. This makes it necessary for those doing research in photobiology to have a good command of how UV, visible and infrared radiation interact with objects and organisms. The aim of this chapter is to provide a foundation for later chapters in the book. 
...
In the absence of waves, specular reflection predominates, and how the surface looks to us depends on our position relative to the sun and clouds. With waves, how the water surface looks to us will be less dependent on our position and we will no longer recognize the reflection of clouds and the sun.
...
![Refraction alters the angle of the beam, creating reflection but also displaces the transmitted light beam, modifying the path length. [From Wiki Commons](https://commons.wikimedia.org/wiki/File:Beam-displacement-inv.svg)](figures/Beam-displacement-inv.svg){#fig-beam-displ}
...
A _pigment_ is a light absorbing chemical or biochemical molecule. Which wavelengths are absorbed or not is determined by the allowed energy levels and transitions because only photons with "matching" energy can be absorbed. Pigments excited by interaction with one or more photons are said to be "excited". The additional energy absorbed from photons is dissipated through different excitation decay mechanisms.
:::

![The Perrin-Jablonski diagram showing energy states. The absorption of a photon is depicted together with the different pathways for energy disipation. Energy increases upwards on the vertical axis. (Modified [diagram by Germain Salvato-Vallverdu.](https://texample.net/tikz/examples/the-perrin-jablonski-diagram/).)](figures/perrin-jablonski-diagram.png){#fig-jablonka fig-alt="Diagram" fig-align="center" width="90%"}

**Some ideas of what the contents could include**

-  Photon absorption and molecule/atom excitation
...
NIST publication 330 [@Newell2019] describes the International System of Units (SI) in great detail, and together with the IUPAC Gold Book can help clarify the use of units in  and technical publications.
