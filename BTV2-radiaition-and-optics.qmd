...
| $Afr$            | fraction         | Absorptance:               |
| $A$              | fraction         | Absorbance:               |
| $xxx$            |                  | Molar 
:::
...
The refractive index, $n$, is dependent on wavelength $\lambda$. How strong is this dependency, depends on the material. The refractive index of air is $n = 0$. This dependency affects spectral reflectance [@fig-refl-from-n].
...
A _pigment_ is a light absorbing chemical or biochemical molecule. Pigments release the energy in the absorbed photons through different excitation decay mechanisms described in this section.
:::
